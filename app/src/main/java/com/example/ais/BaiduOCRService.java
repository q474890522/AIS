...
public interface BaiduOCRService {
    ...
    /**
     *通过图片，使用IOCR获取文字信息
     * @param accessToken OCR Access_token
     * @param image 图片经base64编码后的字符串
     * @param templateSign IOCR模板ID
     * @return
     */
    @FormUrlEncoded
    @POST("rest/2.0/solution/v1/iocr/recognise")
    Observable<IOCRRecognitionBean> getIOCRRecognitionResultByImage(@Field("access_token") String accessToken, @Field("image") String image
            , @Field("templateSign") String templateSign);
}
